...
class DatabaseHelper {
  ...
  static final _databaseName = "ContentOffline.db";
  static final _databaseVersion = 1;

  static final table = 'courses';
  static final columnId = '_id';
  static final columnName = 'name';
  static final columnCourseName = 'course_name';
  static final columnContentId = 'content_id';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute('''
          CREATE TABLE $table (
            ...
            $columnContentId INTEGER NOT NULL,
  ...
  Future<List<Map<String, dynamic>>> queryAllCoursesGrouped() async {
    Database db = await instance.database;
  ...
  Future<int> deleteByContentId(int contentId) async {
    Database db = await instance.database;
    return await db.delete(table, where: '$columnContentId = ?', whereArgs: [contentId]);
  }
}